...
- [ ] **OpenAI:** Auf der zentralen Bootcamp-n8n liegen die Zugangsdaten „OpenAI“. Du brauchst sie für **Vektorsuche** (Embeddings), für **Sprache zu Text** (Meeting-Aufnahme in ein Transkript) und für **Text zu Sprache**. Fürs Texten bleibt „Anthropic“ der Normalfall.
- [ ] **Google-Daten (DataForSEO):** Willst du Öffnungszeiten, Adressen oder Bewertungen aus **Google** abfragen, liegen dafür auf der zentralen Bootcamp-n8n die Zugangsdaten „DataForSEO“ bereit (Typ *Basic Auth*). ⚠️ Jede Abfrage kostet echtes Geld, rund 0,005 USD je Betrieb — teste zuerst mit **einem** Betrieb, nicht mit einer Liste. Und setze das Land auf Österreich, sonst sucht der Dienst in Deutschland.
